...
if __name__ == "__main__":
    ...
    model_path = "./length_classifier.pth"  # Replace with your model's path
    ...
    image_path = "./augmented_data/note_B4_quarter_variation_1_3.png"  # Replace with your test image
